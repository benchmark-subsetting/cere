...
c
       real*8 v1old(in,jn,kn),v2old(in,jn,kn),v3old(in,jn,kn)
     1     ,v1new(in,jn,kn),v2new(in,jn,kn),v3new(in,jn,kn)
     2     ,s1   (in,jn,kn),s2   (in,jn,kn),s3   (in,jn,kn)
c
...
c
       call avisc (is+1,ie-1,js+1,je-1,ks+1,k1  ,dvdxmn
...
c
c    2) Do second portion of the interior points, and some on borders.
c
       call avisc (is  ,is  ,js+1,je-1,ks+1,k1  ,dvdxmn
     &            ,v1old,v2old,v3old,v1new,v2new,v3new,s1,s2,s3)
       call avisc (ie  ,ie  ,js+1,je-1,ks+1,k1  ,dvdxmn
     &            ,v1old,v2old,v3old,v1new,v2new,v3new,s1,s2,s3)
       call avisc (is  ,ie  ,js+1,je-1,k1+1,k2  ,dvdxmn
     &            ,v1old,v2old,v3old,v1new,v2new,v3new,s1,s2,s3)
...
c
c    2) Do last portion of the interior points, and some on borders.
c
       call avisc (is  ,ie  ,js  ,js  ,ks+1,k2  ,dvdxmn
     &            ,v1old,v2old,v3old,v1new,v2new,v3new,s1,s2,s3)
       call avisc (is  ,ie  ,je  ,je  ,ks+1,k2  ,dvdxmn
     &            ,v1old,v2old,v3old,v1new,v2new,v3new,s1,s2,s3)
       call avisc (is  ,ie  ,js  ,je  ,k2+1,ke-1,dvdxmn
     &            ,v1old,v2old,v3old,v1new,v2new,v3new,s1,s2,s3)
c
...
c
     ...
     &            ,v1old,v2old,v3old,v1new,v2new,v3new,s1,s2,s3)
       call avisc (is  ,ie  ,js  ,je  ,ke  ,ke  ,dvdxmn
     &            ,v1old,v2old,v3old,v1new,v2new,v3new,s1,s2,s3)
c
c......................................................................
c
