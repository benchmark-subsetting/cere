...
c
c  LAST MODIFIED
c    02/17/97,  on 3 Mar 98 by M-M Mac Low
c
c  INPUT
...
C#if defined GRAV || defined GRAV_FFT
C       call bvalgp (1,1,0,0,0,0,gp)
C#endif 
