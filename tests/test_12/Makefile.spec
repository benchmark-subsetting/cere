...
commandexe       = leslie3d_base.amd64-m64-gcc43-nn
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/users/mbordet/EXASCALE/codes/SPEC/CTI_SPEC_2006/result/CPU2006.049.log
lognum           = 049
mach             = default
mail_reports     = all
mailcompress     = 0
...
path             = /home/users/mbordet/EXASCALE/codes/SPEC/CTI_SPEC_2006/benchspec/CPU2006/437.leslie3d
plain_train      = 1
preenv           = 1
prefix           = 
prepared_by      = 
...
run              = all
rundir           = run
runspec          = /home/users/mbordet/EXASCALE/codes/SPEC/CTI_SPEC_2006/bin/runspec --config=my_config.cfg --action=run 437 --size=test --noreportable
safe_eval        = 1
