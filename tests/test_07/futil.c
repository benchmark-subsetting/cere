/*
 * $Id: futil.c,v 1.29 2002/03/13 12:46:22 spoel Exp $
 * 
 ...
 */
static char *SRCID_futil_c = "$Id: futil.c,v 1.29 2002/03/13 12:46:22 spoel Exp $";
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <sys/types.h>
...
#define GMXLIBDIR "C:\\program\\gromacs\\share\\top"
#define DIR_SEPARATOR '\\'
#define PATH_SEPARATOR ";"
#else
#define GMXLIBDIR "/usr/local/gromacs/share/top"
#define DIR_SEPARATOR '/'
#define PATH_SEPARATOR ":"
#endif
...
#define VERSION "specbench-3.1.2"
...
FILE *ffopen(char *file,char *mode)
{
  ...
  if (fexist(buf) || !bRead) {
    ...
    bufsize = NULL;
#else
    bufsize=getenv("LOG_BUFS");
#endif
    if (bUnbuffered || (bufsize != NULL)) {
