...
function do_test()
{
    ...
    make clean
    make -j4 INVITRO_CALL_COUNT=1 MODE="replay --region=__extracted__fnbf_do_fnbf_232 --invocation=7948 --instrument --lib=../../src/rdtsc/librdtsc.a --wrapper=../../src/ccc/lel/librdtsc_wrapper.a"
