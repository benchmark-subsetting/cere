...
CC               = ../../src/cerec ${MODE} ${INSTRU} ${INSTRU_OPTS}
COPTIMIZE        = -O3
CLD              = ../../src/cerec ${MODE} ${INSTRU}
CXX              = ../../src/cerec ${MODE} ${INSTRU} ${INSTRU_OPTS}
CXXOPTIMIZE      = -O3
CXXLD            = ../../src/cerec ${MODE} ${INSTRU}
FC               = ../../src/cerec ${MODE} ${INSTRU} ${INSTRU_OPTS}
FOPTIMIZE        = -O3
FLD              = ../../src/cerec ${MODE} ${INSTRU}
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/users/mbordet/EXASCALE/codes/SPEC/CTI_SPEC_2006/result/CPU2006.058.log
lognum           = 058
mach             = default
mail_reports     = all
mailcompress     = 0
...
path             = /home/users/mbordet/EXASCALE/codes/SPEC/CTI_SPEC_2006/benchspec/CPU2006/470.lbm
plain_train      = 1
preenv           = 1
prefix           = 
prepared_by      = 
...
run              = all
rundir           = run
runspec          = /home/users/mbordet/EXASCALE/codes/SPEC/CTI_SPEC_2006/bin/runspec --config=my_config.cfg --action=run all --size=test --noreportable
safe_eval        = 1
